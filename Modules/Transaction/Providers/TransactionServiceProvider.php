...
class TransactionServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->register(TransactionEventServiceProvider::class);
        $this->app->register(TransactionRouteServiceProvider::class);
        $this->app->register(TransactionRepositoryServiceProvider::class);
        $this->app->register(TransactionAuthServiceProvider::class);
    }
