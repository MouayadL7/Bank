...
class SharedServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->register(SharedRouteServiceProvider::class);
        $this->app->register(SharedRepositoryServiceProvider::class);
        $this->app->register(SharedAuthServiceProvider::class);
