...
class RecurringServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected string $nameLower = 'recurring';
    ...
    {
        $this->app->register(RecurringEventServiceProvider::class);
        $this->app->register(RecurringRouteServiceProvider::class);
        $this->app->register(RecurringRepositoryServiceProvider::class);
        $this->app->register(RecurringAuthServiceProvider::class);
    }
