...
class AccessControlServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected string $nameLower = 'access_control';
    ...
    {
        $this->app->register(AccessControlEventServiceProvider::class);
        $this->app->register(AccessControlRouteServiceProvider::class);
        $this->app->register(AccessControlRepositoryServiceProvider::class);
        $this->app->register(AccessControlAuthServiceProvider::class);
    }
